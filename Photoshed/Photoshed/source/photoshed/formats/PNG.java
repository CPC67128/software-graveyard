...
public final class PNG extends ExtensionChecker implements ImageIO
{
	public PNG()
	{
		extension.put("PNG", this);
		description = "Portable Network Graphics Image Files";
		version = "v 0.1";
	}
	...
	public void write(BufferedImage imageSource, File f) {
		ImageReaderWriter.write(imageSource, f, "png");
	}
}